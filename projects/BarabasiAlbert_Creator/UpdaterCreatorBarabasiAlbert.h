 ...
 * @file
 *
 * @class UpdaterCreatorBarabasiAlbert
 *
 * @brief create Updater for a Barabasi-Albert tree with m=1
 * 
 * @details A single a Barabasi-Albert graph with m0=2 and m=1 is created.
 * As the attachment of only one leaf is considered only a BA tree is generated.
 *
